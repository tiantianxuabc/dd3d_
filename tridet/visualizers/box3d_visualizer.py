...
class Box3DPredictionVisualizer():
    ...
    def visualize(self, x):
        ...
        cv2.putText(viz_image,"gt_3d", (30, 30), 1, 1, (255, 0, 0), 2)
        ...
        # cv2.imshow("box3d_image", viz_image)
        cv2.putText(viz_image,"predict_3d", (30, 30), 1, 1, (255, 0, 0), 2)
        ...
        # cv2.imshow("viz_bev", viz_image)
        # cv2.waitKey(100)
        cv2.putText(viz_image,"gt_predict_bev", (30, 30), 1, 1, (255, 0, 0), 2)
